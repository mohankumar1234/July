...
Given I launch "<url>"
When I click the link "<link>" exist in top menu
...
Then I validate the link "<username>" exist in top menu
When I click the link "<logout>" exist in top menu
Then I quit browser
Examples: 
...
When I enter "<passwordID>" in the "<password>" textbox in login page
And I click the button "<login>" in login page
Then I validate the "<error>" displayed in login page
When I click the link "<logout>" exist in top menu
Then I quit browser
Examples: 
